...
{{% alert info %}}
The GCR plugin is an extension around the Docker plugin. Please see the documentation for the [Docker plugin]({{< ref "/drone-plugins/drone-docker/index.md" >}}) for other configuration options.
{{% /alert %}}
